...
\emph{Stringsext} imports the crate \texttt{scoped\_threadpool} to distribute
the \texttt{input\_slice} to its scanner-threads as \emph{shared-memory}. Once a
scanner has accomplished its mission, it sends its result through a dedicated
\emph{message channel} to the \emph{merger-printer}-thread.
