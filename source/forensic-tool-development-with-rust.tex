...
\cite[p. 125]{harichandran2016}. A more formal definition named \emph{Curated
(digital) Forensic Artefact (CuFA)} proposed in \cite[p. 131]{harichandran2016}
...
\item[Verification]
    ...
    techniques and procedures \cite[p. 92]{craiger2006}.
...
\ref{the-search-target-mapping} \cite[p. 17]{beckett2007} shows the search target
...
existing code. ``I often had a queasy feeling when I had to work on other
people's C code.'' ``Do I free the memory at the right moment? Is this pointer
